...
DvG_Stepper::DvG_Stepper(Adafruit_StepperMotor *stepper,
...
void DvG_Stepper::turn_on() { _running = true; }
...
bool DvG_Stepper::running() { return _running; }
...
uint8_t DvG_Stepper::style() { return _style; }

void DvG_Stepper::moveTo(int32_t absolute) { _targetPos = absolute; }

void DvG_Stepper::move(int32_t relative) { moveTo(_currentPos + relative); }

int32_t DvG_Stepper::distanceToGo() { return _targetPos - _currentPos; }

int32_t DvG_Stepper::targetPosition() { return _targetPos; }

int32_t DvG_Stepper::currentPosition() { return _currentPos; }
...
float DvG_Stepper::speed() { return _speed_rev_per_sec; }

float DvG_Stepper::speed_steps_per_sec() { return _speed_steps_per_sec; }
